...
- **Deployed Flagship Article**: Converted the staged markdown article to MDX/Metadata format and deployed it to the live site [residual-labs.fr/blog/proving-a-62k-star-repo](https://residual-labs.fr/blog/proving-a-62k-star-repo) (repo: `zakariagharzouli/residual-labs-v1`).

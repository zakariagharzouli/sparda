...
- **Reconstruction de la chaîne de release et passage à NPM OIDC Trusted Publishing** (ADR-108, E-121).
  ...
  - Corrige les liens utilisateur restants vers l'ancien propriétaire GitHub sans modifier les identités distinctes VS Code, MCP et Glama.
